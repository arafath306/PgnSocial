...
class ReplyInputComposer extends StatelessWidget {
  ...
  final VoidCallback? onPauseResumeVoiceRecord;
  final VoidCallback? onCancelVoiceRecord;
  final VoidCallback? onSendVoiceRecord;
  ...
  const ReplyInputComposer({
    ...
    this.onPauseResumeVoiceRecord,
    this.onCancelVoiceRecord,
    this.onSendVoiceRecord,
    ...
    return Padding(
      ...
      child: isVoiceRecording
          ? SharedVoiceRecordingBar(
              ...
              onPauseResume: onPauseResumeVoiceRecord,
              onCancel: onCancelVoiceRecord ?? () {},
              onSend: onSendVoiceRecord ?? () {},
