            ...
            children: [
              ...
              ListTile(
                leading: Container(
                  ...
                  child: const Icon(Icons.camera_alt_rounded, color: Color(0xFF64748B), size: 22),
                ),
                title: Text(
              ...
              ListTile(
                leading: Container(
                  ...
                  child: const Icon(Icons.photo_library_rounded, color: Color(0xFF64748B), size: 22),
                ),
                title: Text(
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: const BadgeAppBarTitle(isGovernment: true),
        centerTitle: true,
      ),
      body: SafeArea(
        child: Column(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      IdUploadCard(
                        ...
                        onClear: req.govIdCardImage != null ? () => setState(() => req.govIdCardImage = null) : null,
                      ),
                      ...
                      if (isPremium) ...[
                        IdUploadCard(
                          ...
                          onClear: req.govAuthorizationLetterImage != null ? () => setState(() => req.govAuthorizationLetterImage = null) : null,
                        ),
                        const SizedBox(height: 14),
                      ],
